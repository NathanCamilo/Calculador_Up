...
Item {
    ...
    Rectangle {
        ...
        Label {
            ...
            height: 48
            color: "#ffffff"
            text: qsTr("Parafuso de Cabeça Cilindrica Boleada com Fenda")
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                Label {
                    ...
                    height: 47
                    color: "#ffffff"
                    text: qsTr("Proporciona bom acabamento na \nsuperfície dos componentes.")
                    anchors.left: icon2.right
        ...
        Rectangle {
            ...
            Image {
                ...
                anchors.top: parent.top
                anchors.bottom: parent.bottom
                source: "../../../images/CabeçaCilindricaLayoutCorpo.png"
...
/*##^##
Designer {
    D{i:0;autoSize:true;formeditorZoom:0.75;height:480;width:800}D{i:33}
}
##^##*/
