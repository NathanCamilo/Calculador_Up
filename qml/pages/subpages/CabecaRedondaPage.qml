    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Label {
                ...
                height: 50
                color: "#e7f3ff"
                text: qsTr("Insira os dados do parafuso: Cabeça redonda com fenda")
                anchors.fill: parent
        ...
        StackView {
            ...
            Custombtn{
                ...
                font.pointSize: 10
                onClicked: {
                    stackViewresults.push(Qt.resolvedUrl("Resultspagecdrcld.qml"))
                    backend.finishcdrBtn(finishcbrBtn.down)
                    cont = 2
                }
            }
