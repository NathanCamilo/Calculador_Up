...
Item {
    property color pressionado: "#ffffff"
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Label {
                ...
                height: 50
                color: "#e7f3ff"
                text: qsTr("Insira os dados do parafuso: Sextavado")
                anchors.fill: parent
        ...
        StackView {
            ...
            Custombtn{
                ...
                font.pointSize: 10
                onClicked: {
                    stackViewresults.push(Qt.resolvedUrl("Resultspagesextavado.qml"))
                    backend.finishsxtBtn(finishsxtBtn.down)
                }
            }
